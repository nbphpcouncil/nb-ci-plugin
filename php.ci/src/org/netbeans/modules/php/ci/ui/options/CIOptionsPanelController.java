 ...
 */
package org.netbeans.modules.php.ci.ui.options;
...
keywordsCategory = "org-netbeans-modules-php-project-ui-options-PHPOptionsCategory/CI")
public final class CIOptionsPanelController extends OptionsPanelController {
    ...
    private CIOptionsPanel getPanel() {
        if (panel == null) {
            panel = new CIOptionsPanel(this);
        }
